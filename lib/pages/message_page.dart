...
import 'package:whatsapp/customui/own_message_card.dart';
import 'package:whatsapp/customui/reply_message_card.dart';
...
class _MessagePageState extends State<MessagePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        Image.asset(
          "assets/images/message_background_image.png",
